  ...
  async seedEmailsForUser(userId: string): Promise<void> {
    ...
    const seedEmails: InsertEmail[] = [
      ...
      },
      {
        ...
        to: "You",
        toEmail: "me@eomail.co",
        subject: "Coffee chat next week? Let's sync on EOMail",
        body: `<p>Hi there,</p><p>I came across your work on AI email tooling and I'm incredibly impressed. At VentureLab, we're actively looking for startups in the productivity and AI space.</p><p>Would love to grab a virtual coffee and hear more about your vision for EOMail. Are you free Tuesday at 10 AM or Wednesday afternoon next week?</p><p>Best,<br>Priya Patel<br>Partner, VentureLab VC</p>`,
      ...
      },
      {
        ...
        to: "You",
        toEmail: "me@eomail.co",
        subject: "[eomail/core] Pull request merged: Feature/ai-compose #247",
        body: `<p>A pull request was merged into <strong>eomail/core</strong>.</p><p><strong>Feature/ai-compose</strong> by <a href="#">@dev-team</a></p><p>This PR adds the new AI compose feature that suggests email completions as you type.</p><p>Files changed: 12 | +847 / -124</p><p><a href="#">View on GitHub</a></p>`,
        preview: "A pull request was merged into eomail/core. Feature/ai-compose by @dev-team",
        timestamp: hour(8),
        read: true,
        starred: false,
        folder: "inbox",
