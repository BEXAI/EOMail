/**
 * EOMail.co — System Wrapper: Prompt Orchestrator
 * Dynamic prompt templates optimized for specific email tasks.
 * Each template maps to a task type with structured inputs.
 */
...
// ─── Task Complexity (used by API Gateway for model routing) ──────────────────
